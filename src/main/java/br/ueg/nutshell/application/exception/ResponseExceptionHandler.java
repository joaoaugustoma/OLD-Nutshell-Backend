 ...
 * Copyright (c) UEG.
 */
package br.ueg.nutshell.application.exception;

import br.ueg.nutshell.api.exception.ApiRestResponseExceptionHandler;
import br.ueg.nutshell.comum.exception.MessageCode;
...
public class ResponseExceptionHandler extends ApiRestResponseExceptionHandler {
	...
	/**
	 * @see br.ueg.nutshell.api.exception.ApiRestResponseExceptionHandler#getCodeInternalServerError()
	 */
	@Override
